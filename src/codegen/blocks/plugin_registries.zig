...
//!
//! Each function here emits one top-level registry block into the
...
//! controllers contracts (see per-function doc comments below).
//!
...
pub fn writePluginControllersBlock(bw: anytype, cfg: ProjectConfig) !void {
