...
pub fn build(b: *std.Build) void {
    ...
    const backend_dep = b.dependency("labelle_sokol", .{ .target = android_target, .optimize = optimize, .with_imgui = false, .dont_link_system_libs = true });
