...
pub fn build(b: *std.Build) void {
    ...
    const plugin_pathfinding_dep = b.dependency("labelle_pathfinding", .{ .target = target, .optimize = optimize });
    const plugin_pathfinding_mod = plugin_pathfinding_dep.module("labelle_pathfinding");
    ...
    const backend_dep = b.dependency("labelle_sokol", .{ .target = target, .optimize = optimize, .with_imgui = false, .gamepad_enabled = true, .gamepad_hidapi = false });
    ...
    overrideImport(plugin_pathfinding_mod, "labelle-core", core_mod);
    overrideImport(plugin_pathfinding_mod, "labelle-gfx", gfx_mod);
    overrideImport(plugin_pathfinding_mod, "labelle-engine", engine_mod);
    overrideImport(plugin_pathfinding_mod, "ecs_backend", ecs_mod);
    overrideImport(plugin_pathfinding_mod, "backend_gfx", backend_gfx);
    overrideImport(plugin_pathfinding_mod, "backend_input", backend_input);
    overrideImport(plugin_pathfinding_mod, "backend_audio", backend_audio);
    overrideImport(plugin_pathfinding_mod, "backend_window", backend_window);
    overrideImport(game_mod, "pathfinding", plugin_pathfinding_mod);
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            .imports = &.{
                ...
                .{ .name = "pathfinding", .module = plugin_pathfinding_mod },
